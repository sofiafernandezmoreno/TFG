...
\begin{frame}
	\frametitle{Interfaz GUI: Thruk \includegraphics[scale=0.2]{imagenes/thruk.png}}
	\includegraphics[scale=0.2]{imagenes/thruk.png}
	\centering
	\includegraphics[scale=0.3]{imagenes/arquitecturaThruk.png}
...
\begin{frame}
	...
	\centering
	\includegraphics[scale=0.21]{imagenes/comparativaAutomatizacion.png}
	
	\includegraphics[scale=0.21]{imagenes/ELK.png}
\end{frame}
\subsection{}
\begin{frame}{}{}
