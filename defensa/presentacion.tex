...
\begin{frame}
	...
	\begin{prop}
		El inconveniente de usar plugins en Naemon no tiene reflejo de qué es lo que está monitorizando, simplemente rastrea los cambios en el estado de esos recursos.
	\end{prop}
