...
\begin{figure}
	\centering
	\includegraphics[scale=0.2]{imagenes/definicion_objetos/hosts.png}
	\includegraphics[scale=0.2]{imagenes/definicion_objetos/services.png}
	\includegraphics[scale=0.2]{imagenes/definicion_objetos/time_period.png}
	\includegraphics[scale=0.2]{imagenes/definicion_objetos/command.png}
	\includegraphics[scale=0.2]{imagenes/definicion_objetos/contact.png}
	
\end{figure}

	\includegraphics[scale=0.5]{imagenes/definicion_objetos/hosts.png}
	\includegraphics[scale=0.5]{imagenes/definicion_objetos/services.png}
	\includegraphics[scale=0.5]{imagenes/definicion_objetos/time_period.png}
	\includegraphics[scale=0.5]{imagenes/definicion_objetos/command.png}
	\includegraphics[scale=0.5]{imagenes/definicion_objetos/contact.png}
