...
\begin{frame}
	...
	\begin{defn}
		...
		Nagios que analiza los datos de rendimiento de los servicios que tengamos implementados en cada host, almacena automáticamente los datos en bases	de datos RRD (bases de datos Round Robin).
	\end{defn}
\end{frame}
\begin{frame}
