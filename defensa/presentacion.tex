...
\begin{frame}
	...
	\item Number of users simulate
	\item Hatch rate: representa por cada segundo, cuántos usuarios se agregarán a los usuarios actuales hasta la cantidad total de usuarios. Cada hatch realizado Locust llama a la función on start si existe.
\end{itemize}
