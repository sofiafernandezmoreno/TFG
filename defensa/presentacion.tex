...
\begin{frame}
	...
	\centering
	\includegraphics[scale=0.3]{imagenes/analisis_naemon/host.png}
	\includegraphics[scale=0.1]{imagenes/analisis_naemon/services1.png}
	\includegraphics[scale=0.1]{imagenes/analisis_naemon/services2.png}
