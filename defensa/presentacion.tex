...
\section{Realización del despliegue} % Sections can be created in order to organize your presentation into discrete blocks, all sections and subsections are automatically printed in the table of contents as an overview of the talk
%------------------------------------------------
\begin{frame}
	...
	\begin{itemize}
		...
		\item Realizar despliegue mediante orquestación estática
		\item Enlazar en el despliegue el sistema a analizar
		\item Realizar pruebas de carga con herramienta Locust
	\end{itemize}
