...
\begin{frame}
	...
	\item $<format>$ especifica el formato de exportación, teniéndose la opción
	de XML, JSON y CSV.
	\item $<hostname>$ especificaremos el nombre del host, en este caso intro-
	ducimos el nombre wordpress.
	\item $<servicedesc>$ especificaremos el servicio que queremos exportar su
	información.
\end{frame}
\begin{frame}
