...
\begin{frame}
	...
	\begin{definition}
		Para poder realizar el despliegue tendremos que crear el fichero
		Dockerfile. Con este fichero construiremos la imagen de Naemon de forma
		automática, leyendo las instrucciones que le indiquemos.
	\end{definition}
	\centering
