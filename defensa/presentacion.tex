...
\begin{frame}
	...
	\begin{block}
		...
		Los \textbf{plugins} actúan como una capa de abstracción entre la
		lógica de supervisión presente en el demonio de Naemon y los servicios y
		hosts reales que se están supervisando.
	\end{block}
	\centering
	\includegraphics[scale=0.5]{imagenes/plugins.png}
