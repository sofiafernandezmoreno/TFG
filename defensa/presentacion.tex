...
\begin{frame}
	...
	exportación a CSV de la siguiente forma: /pnp4nagios/xport/<format>
	?host=<hostname>&srv=<servicedesc>. Donde:
	< f ormat > especifica el formato de exportación, teniéndose la opción
	de XML, JSON y CSV.
	< hostname > especificaremos el nombre del host, en este caso intro-
	ducimos el nombre wordpress.
	< servicedesc > especificaremos el servicio que queremos exportar su
	información.
\end{frame}
\begin{frame}
